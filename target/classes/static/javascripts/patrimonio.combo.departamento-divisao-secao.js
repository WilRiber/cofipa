...
Cofipa.ComboDivisao2 = (function() { // cria o objeto departamento
	...
	ComboDivisao2.prototype.iniciar = function() {
		this.combo.on('change', onDivisaoAlterado.bind(this));
	}
	
	function onDivisaoAlterado() {
...
Cofipa.ComboSecao = (function() {
	...
	ComboSecao.prototype.iniciar = function() {
		reset.call(this);
		this.comboDivisao2.on('alterado', onDivisaoAlterado.bind(this));
		this.combo.on('change', onSecaoAlterada.bind(this));
	...
	function onDivisaoAlterado(evento, codigoDivisao) {
	//	console.log('divisao selecionada', codigoDivisao)
	//	console.log('divisao', codigoDivisao)
	...
	function onSecaoAlterada(evento, codigoSecao) {
		//console.log('secao selecionada', codigoSecao)
		//console.log('secao', codigoSecao)
		this.inputHiddenSecaoSelecionada.val('');
	...
	function onBuscarSecoesFinalizado(secoes) {
		...
		secoes.forEach(function(secao) {
			//console.log('secoes', secao.codigo)
			//console.log('seção selecionada', secao.codigo)
...
$(function() {
	...
	//var comboSecao2 = new Cofipa.ComboSecao2();
	//comboSecao2.iniciar();
	...
	//var comboSecao = new Cofipa.ComboSecao(comboSecao2);
	//comboSecao.iniciar();
